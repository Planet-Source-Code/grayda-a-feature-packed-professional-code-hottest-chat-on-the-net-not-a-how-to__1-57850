...
a1(12).BackColor = frmMain.txtChat.BackColor
...
txtChat.Text = ""
txtChat.BackColor = a1(12).BackColor

txt "Welcome to NChat ", Heading, True, False, False, 18, vbCenter
txt "Alpha!!" & vbCrLf, ThatsGood, True, False, False, 18, vbCenter
txt "Created by Grayda of Solid Inc." & vbCrLf, Heading, , , , 7, vbCenter
txt ":nchat" & vbCrLf & "http://www.solidinc.tk" & vbCrLf, Heading, False, False, False, 7, vbCenter
txt "Preparting to Start NChat Alpha, Please stand by..." & vbCrLf, Heading, True, False, False, 8, vbCenter
CheckRTF txtChat
txt Text3.Text & vbCrLf, a1(0).BackColor, True, , , , vbCenter
For i = 0 To 49
If List1.List(i) > "" Then txt List1.List(i) & vbCrLf, a1(0).BackColor, True, False, True, , vbCenter
Next i
txt "+username+ has entered the conversation!" & vbCrLf, a1(3).BackColor, True, False, False, 8, vbCenter
...
txt "Some_Guy has left the room" & vbCrLf, a1(2).BackColor, True, False, False, 8, vbCenter
txtChat.SelStart = 0
End Sub
