...
If Right(List1.SelectedItem.Key, Len(List1.SelectedItem.Key) - 1) > 0 And List1.SelectedItem.Text > "" Then
NewRoom Right(List1.SelectedItem.Key, Len(List1.SelectedItem.Key) - 1), List1.SelectedItem.Text
Unload Me
Else
