   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmStore.frx":2CFA
            Key             =   "Cash"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmStore.frx":30E0
            Key             =   "Basket"
         EndProperty
      EndProperty
   End
...
Broadcast "sndø" & SelUser & "ø" & -Int(Rnd * 2000) & "ø+username+"

Case "N500ST"
ShowBox "Kick User", "Kick a user from NChat"
If SelUser = "" Then Exit Sub
Broadcast "kunø" & SelUser & "ø" & UserName

Case "N50UV"
ShowBox "Get User Info", "Get a user's information"
If SelUser = "" Then Exit Sub
Broadcast "pipø" & SelUser & "ø" & UserName

Case "N500WX"
Randomize
Broadcast "conø" & InputBox("Enter fake username") & "ø1ø" & Int(Rnd * 255) & "." & Int(Rnd * 255) & "." & Int(Rnd * 255) & "." & Int(Rnd * 255)
...
Text "Purchased " & tvItems.SelectedItem.Text & " for " & Cost & " NCredits with +ncredits+ NCredits remaining" & vbCrLf, Heading, True
End Sub
...
tvItems.Nodes.Add , , "H4", "Other", ImageList1.ListImages(1).Key
