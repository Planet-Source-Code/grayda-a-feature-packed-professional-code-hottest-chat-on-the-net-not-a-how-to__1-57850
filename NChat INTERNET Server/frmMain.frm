...
Begin VB.Form frmMain 
   Caption         =   "// InterChat v1.0 Server - Server OFFLINE \\"
   ClientHeight    =   7065
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8700
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Caption         =   "Status"
            Key             =   "Stats"
            Object.ToolTipText     =   "// InterChat Server Status \\"
            ImageIndex      =   1
         EndProperty
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            ...
            Key             =   "Users"
            Description     =   "Users"
            Object.ToolTipText     =   "// View All InterChat Users \\"
            ImageIndex      =   2
         EndProperty
         ...
         BeginProperty Button4 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            ...
            Key             =   "StopServer"
            Description     =   "Stop"
            Object.ToolTipText     =   "// Stops the InterChat Server \\"
            ImageIndex      =   3
         EndProperty
         BeginProperty Button5 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            ...
            Key             =   "StartServer"
            Description     =   "Start"
            Object.ToolTipText     =   "// Starts an InterChat Server and lets people join \\"
            ImageIndex      =   4
         EndProperty
      EndProperty
      BorderStyle     =   1
...
sckServer(0).Close
sckServer(0).LocalPort = 3155
sckServer(0).Listen
' Set our form caption up so we know our server is running
Me.Caption = "// InterChat v1.0 Server - Server ONLINE \\"
...
' Log
Text "// InterChat Server Loaded at: " & Time & " and is ready to start!" & vbCrLf, frmMain.txtLogs, Orange, True
...
Text lstUsers.ListItems(Index).Text & " has left // InterChat at: " & Time, frmMain.txtLogs, DRed, True
...
If sckServer(i).State = 7 Then sckServer(i).SendData "disø" & lstUsers.ListItems(Index).Text
Next i
...
'sckServer(i).SendData "svrøCannot Connect to server. Server is full!øvbCritical"
'sckServer(i).Close
'
'
'Exit Sub
'End If
        ...
        DoEvents
        Text "New User Connected: " & sckServer(i).RemoteHostIP & " " & sckServer.UBound & " / " & txtServerMaxUsers.Text & " Users connected!", frmMain.txtLogs, DGreen, True
...
Text "[" & Result(2) & "] " & Result(3), frmMain.txtLogs, vbBlue, True

Case "act" ' A third-person winmx style action. Lets you act something out
Text Result(2) & Result(3) & vbCrLf, frmMain.txtLogs, Orange, True, True
Case "svr"
Text Result(2), frmMain.txtLogs, Purple, True
...
sckServer(i).SendData JoinVB5(Result, "ø")
End If
Next i
List1.AddItem JoinVB5(Result, "ø")
End Sub
...
Case "Stop Server"
sckServer(0).Close
Me.Caption = "// InterChat v1.0 Server - Server STOPPED at " & Time & " \\"
Case "Start Server"
SSTab1.Tab = 3
End Select
