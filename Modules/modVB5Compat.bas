Attribute VB_Name = "modVB5Compat"
' This module ensures at least some compatability with VIsual Basic 5 and lower.
' Split and Join, as well as instrrev are not supported on VB5, and the split
' command is the heart of the data arrival sub.

' Some Enums for our subs.
' Binary compare is case SENSITIVE,
' while Text compare is case =IN=Sensitive
...
'Expression:    The string to SplitVB5.
'Delimiter:     The delimiter used for the SplitVB5.
